...
const PAYPAL_CLIENT_ID =
  "ATGkWfD8UGclDHHK4YRb6cvIuaVRso1jLziLeVwsuXgfAcKSePcq1Y9hVuEd5mvhJ6v8AY9RjEtU1dmb";
const PAYPAL_CLIENT_SECRET =
  "EGVs1PlFS0MQQZeDARCi_K19z2-fYZE6Ph8we3xCrGWsCeyr4MtxZxnvAruPweQYZkmil2XaJzWg5SNu";
...
export const createFinalOrder = async (
  ...
  try {
    ...
    if (!userId || !items || !addressId || !total || !paymentId) {
      res.status(400).json({
        success: false,
